<?php
namespace osi;
class ObjectStorage_UserInfo{
	static private $_serverParams = array(
				0 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_00'),
				1 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_01'),
				2 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_02'),
				3 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_03'),
				4 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_04'),
				5 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_05'),
				6 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_06'),
				7 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_07'),
				8 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_08'),
				9 => array('host' => 'localhost', 'port' => 3306, 'user' => 'root', 'password' => '', 'database' => 'db_example_user', 'table' => 'tb_09'),
			);
