...
#backend compiling
    ...
    php ${SCRIPT_FOLDER}/../backend/object_renderer.php "${SCRIPT_FOLDER}/../backend/helper/object_sql.html" "${TARGET_FOLDER}/tmp.def" "${TARGET_FOLDER}/tmp.router.current" "" > $TARGET_FOLDER/$mod_path/$mod_name.sql 
