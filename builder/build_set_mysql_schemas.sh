...
#backend compiling
    ...
    php ${SCRIPT_FOLDER}/../backend/set_renderer.php "${SCRIPT_FOLDER}/../backend/helper/set_sql.html" "${TARGET_FOLDER}/tmp.def" "${TARGET_FOLDER}/tmp.router.current" "" > $TARGET_FOLDER/$mod_path/$mod_name.sql 
